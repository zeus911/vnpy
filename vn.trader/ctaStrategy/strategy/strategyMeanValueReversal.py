...
class MVRStrategy(CtaTemplate):
    ...
    def onFiveBar(self, bar):
        ...
        if self.pos == 0 and 0.01 >= self.atrValue/bar.close >= 0.001:
            ...
            #夜盘开仓
            if datetime.datetime.strptime("23:00:00", "%H:%M:%S").time() > timeA > datetime.datetime.strptime("15:00:00", "%H:%M:%S").time():
    ...
    def onTrade(self, trade):
        ...
        # 通知我一下
        #yagmail.SMTP('MeanValueReversal').send('95432531@qq.com', 'MVRStrategy' + trade.direction + trade.offset , trade.__dict__)
